...
export function Chart({ symbol, timeframe, bars, theme = DARK_THEME, className }: ChartProps): JSX.Element {
  ...
  // Engine is recreated only when symbol or timeframe change; bars are pushed below.
